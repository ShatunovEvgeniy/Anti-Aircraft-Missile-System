...
![Диаграмма последовательности запуска симуляции](2.png)
...
![Поток данных при запуске ракеты](3.png)
